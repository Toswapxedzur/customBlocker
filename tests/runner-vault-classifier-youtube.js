...
setTimeout(() => {
  const collection = messages.find((message) => message.type === "vault-classifier-collect");
  const passes = Boolean(collection
  ...
  console.error("FAIL YouTube handle-only collector fixture", { collection, errors, messages });
